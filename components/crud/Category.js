...
const Category = () => {
  ...
  const showSuccess = () => {
    if (success) {
      return <p className='text-success'>Catagory is created</p>;
    }
  };

  const showError = () => {
    if (error) {
      return <p className='text-danger'>Catagory already exist</p>;
    }
  };

  const showRemove = () => {
    if (removed) {
      return <p className='text-danger'>Catagory is removed</p>;
    }
  };
